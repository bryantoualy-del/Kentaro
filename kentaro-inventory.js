...
const retiredItemIds=['memory-lantern','memory-flower','silent-heart'];
...
function exportInventory(){
 const payload={kind:'kentaro-inventory',version:4,exportedAt:new Date().toISOString(),inventory:JSON.parse(JSON.stringify(normalize()))};
